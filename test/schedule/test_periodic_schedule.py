...
CAL = HolidayCalendar(HolidayCalendarType.SAT_SUN)
...
BDA = BDayAdj(BDayAdjType.MODIFIED_FOLLOWING, CAL)
...
def data_gen():
    return [
        ...
        #  [JUN_17, JUL_17, AUG_17, SEP_17], [JUN_17, JUL_17, AUG_18, SEP_17],
        ...
        #  [JUN_17, JUL_17, AUG_17, SEP_17], [JUN_17, JUL_17, AUG_18, SEP_17],
        #  RollConvention(RollConventionType.DAY_17)],
        # [JUN_17, JUL_04, Frequency(months=1), StubConvention(StubConventionType.SHORT_INITIAL), None, BDA, None, None,
        #  None,
        ...
        #  StubConvention(StubConventionType.SHORT_INITIAL), RollConvention(RollConventionType.EOM), BDA, None, None,
        #  None,
        ...
        #  [datetime(2014, 12, 12), datetime(2015, 2, 24), datetime(2015, 5, 25), datetime(2015, 8, 24)],
        #  RollConvention(RollConventionType.DAY_24)],
        # [datetime(2014, 12, 12), datetime(2015, 8, 24), Frequency(months=3),
        #  StubConvention(StubConventionType.SHORT_INITIAL), RollConvention(RollConventionType.NONE), BDA, None, None,
        #  None,
        #  [datetime(2014, 12, 12), datetime(2015, 2, 24), datetime(2015, 5, 24), datetime(2015, 8, 24)],
        #  [datetime(2014, 12, 12), datetime(2015, 2, 24), datetime(2015, 5, 25), datetime(2015, 8, 24)],
        #  RollConvention(RollConventionType.DAY_24)],
        # [datetime(2014, 11, 24), datetime(2015, 8, 24), Frequency(months=3), None,
        #  RollConvention(RollConventionType.NONE), BDA, None, None,
        #  None,
        #  [datetime(2014, 11, 24), datetime(2015, 2, 24), datetime(2015, 5, 24), datetime(2015, 8, 24)],
        #  [datetime(2014, 11, 24), datetime(2015, 2, 24), datetime(2015, 5, 25), datetime(2015, 8, 24)],
        #  RollConvention(RollConventionType.DAY_24)],

        # # stub StubConvention(StubConventionType.LONG_INITIAL)
        # [JUN_04, SEP_17, Frequency(months=1), StubConvention(StubConventionType.LONG_INITIAL), None, BDA, None, None,
        #  None,
        #  [JUN_04, JUL_17, AUG_17, SEP_17],
        #  [JUN_04, JUL_17, AUG_18, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_17, SEP_17, Frequency(months=1), StubConvention(StubConventionType.LONG_INITIAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, JUL_17, AUG_17, SEP_17],
        #  [JUN_17, JUL_17, AUG_18, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_17, JUL_04, Frequency(months=1), StubConvention(StubConventionType.LONG_INITIAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, JUL_04], [JUN_17, JUL_04], RollConvention(RollConventionType.DAY_4)],
        # [JUN_17, AUG_04, Frequency(months=1), StubConvention(StubConventionType.LONG_INITIAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, AUG_04], [JUN_17, AUG_04], RollConvention(RollConventionType.DAY_4)],

        # # stub StubConvention(StubConventionType.SMART_INITIAL)
        # [JUN_04, SEP_17, Frequency(months=1), StubConvention(StubConventionType.SMART_INITIAL), None, BDA, None, None,
        #  None,
        #  [JUN_04, JUN_17, JUL_17, AUG_17, SEP_17],
        #  [JUN_04, JUN_17, JUL_17, AUG_18, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_10, SEP_17, Frequency(months=1), StubConvention(StubConventionType.SMART_INITIAL), None, BDA, None, None,
        #  None,
        #  [JUN_10, JUN_17, JUL_17, AUG_17, SEP_17],
        #  [JUN_10, JUN_17, JUL_17, AUG_18, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_11, SEP_17, Frequency(months=1), StubConvention(StubConventionType.SMART_INITIAL), None, BDA, None, None,
        #  None,
        #  [JUN_11, JUL_17, AUG_17, SEP_17],
        #  [JUN_11, JUL_17, AUG_18, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_17, JUL_04, Frequency(months=1), StubConvention(StubConventionType.SMART_INITIAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, JUL_04], [JUN_17, JUL_04], RollConvention(RollConventionType.DAY_4)],

        # # stub StubConvention(StubConventionType.SHORT_FINAL)
        # [JUN_04, SEP_17, Frequency(months=1), StubConvention(StubConventionType.SHORT_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_04, JUL_04, AUG_04, SEP_04, SEP_17], [JUN_04, JUL_04, AUG_04, SEP_04, SEP_17],
        #  RollConvention(RollConventionType.DAY_4)],
        # [JUN_17, SEP_17, Frequency(months=1), StubConvention(StubConventionType.SHORT_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, JUL_17, AUG_17, SEP_17], [JUN_17, JUL_17, AUG_18, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_17, JUL_04, Frequency(months=1), StubConvention(StubConventionType.SHORT_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, JUL_04], [JUN_17, JUL_04], RollConvention(RollConventionType.DAY_17)],
        # [datetime(2011, 6, 28), datetime(2011, 6, 30), Frequency(months=1),
        #  StubConvention(StubConventionType.SHORT_FINAL),
        ...
        # [datetime(2014, 11, 29), datetime(2015, 9, 2), Frequency(months=3),
        #  StubConvention(StubConventionType.SHORT_FINAL), None, BDA, None, None, None,
        ...
        # [datetime(2014, 11, 29), datetime(2015, 9, 2), Frequency(months=3),
        #  StubConvention(StubConventionType.SHORT_FINAL), RollConvention(RollConventionType.NONE), BDA, None,
        #  None, None,
        #  [datetime(2014, 11, 29), datetime(2015, 2, 28), datetime(2015, 5, 29), datetime(2015, 8, 29),
        #   datetime(2015, 9, 2)],
        #  [datetime(2014, 11, 28), datetime(2015, 2, 27), datetime(2015, 5, 29), datetime(2015, 8, 31),
        ...
        # [JUN_04, SEP_17, Frequency(months=1), StubConvention(StubConventionType.LONG_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_04, JUL_04, AUG_04, SEP_17],
        #  [JUN_04, JUL_04, AUG_04, SEP_17], RollConvention(RollConventionType.DAY_4)],
        # [JUN_17, SEP_17, Frequency(months=1), StubConvention(StubConventionType.LONG_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, JUL_17, AUG_17, SEP_17],
        #  [JUN_17, JUL_17, AUG_18, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_17, JUL_04, Frequency(months=1), StubConvention(StubConventionType.LONG_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, JUL_04],
        #  [JUN_17, JUL_04], RollConvention(RollConventionType.DAY_17)],
        # [JUN_17, AUG_04, Frequency(months=1), StubConvention(StubConventionType.LONG_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, AUG_04],
        #  [JUN_17, AUG_04], RollConvention(RollConventionType.DAY_17)],

        # # stub StubConvention(StubConventionType.SMART_FINAL)
        # [JUN_04, SEP_17, Frequency(months=1), StubConvention(StubConventionType.SMART_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_04, JUL_04, AUG_04, SEP_04, SEP_17],
        #  [JUN_04, JUL_04, AUG_04, SEP_04, SEP_17], RollConvention(RollConventionType.DAY_4)],
        # [JUN_04, SEP_11, Frequency(months=1), StubConvention(StubConventionType.SMART_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_04, JUL_04, AUG_04, SEP_04, SEP_11],
        #  [JUN_04, JUL_04, AUG_04, SEP_04, SEP_11], RollConvention(RollConventionType.DAY_4)],
        # [JUN_04, SEP_10, Frequency(months=1), StubConvention(StubConventionType.SMART_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_04, JUL_04, AUG_04, SEP_10],
        #  [JUN_04, JUL_04, AUG_04, SEP_10], RollConvention(RollConventionType.DAY_4)],
        # [JUN_17, JUL_04, Frequency(months=1), StubConvention(StubConventionType.SMART_FINAL), None, BDA, None, None,
        #  None,
        #  [JUN_17, JUL_04],
        #  [JUN_17, JUL_04], RollConvention(RollConventionType.DAY_17)],
        ...
        #  [JUN_17, JUL_17, AUG_17, SEP_17],
        #  [JUN_17, JUL_17, AUG_18, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_04, SEP_04, Frequency(months=1), StubConvention(StubConventionType.SMART_FINAL), None, BDA, JUN_17, None,
        #  None,
        ...
        #  [JUN_04, JUL_04, AUG_04, SEP_17],
        #  [JUN_04, JUL_04, AUG_04, SEP_17], RollConvention(RollConventionType.DAY_4)],
        # [JUN_04, SEP_17, Frequency(months=1), StubConvention(StubConventionType.SHORT_FINAL), None, BDA, None, AUG_04,
        #  None,
        #  [JUN_04, JUL_04, AUG_04, SEP_17],
        #  [JUN_04, JUL_04, AUG_04, SEP_17], RollConvention(RollConventionType.DAY_4)],
        ...
        #  [JUN_17, JUL_17, AUG_17, SEP_17],
        #  [JUN_17, JUL_17, AUG_18, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_04, SEP_04, Frequency(months=1), StubConvention(StubConventionType.SMART_INITIAL), None, BDA, None, AUG_17,
        #  None,
        #  [JUN_04, JUN_17, JUL_17, AUG_17, SEP_04],
        #  [JUN_04, JUN_17, JUL_17, AUG_18, SEP_04], RollConvention(RollConventionType.DAY_17)],
        ...
        # [NOV_30_2013, NOV_30, Frequency(months=3), STUB_NONE, RollConvention(RollConventionType.EOM), BDA, None, None,
        #  None,
        ...
        # [datetime(2014, 1, 3), SEP_17, Frequency(months=3), STUB_BOTH, RollConvention(RollConventionType.EOM), BDA,
        #  FEB_28,
        #  AUG_31, None,
        ...
        #  [NOV_29_2013, FEB_28, MAY_30, AUG_29, NOV_28], RollConvention(RollConventionType.EOM)],
        # # RollConvention(RollConventionType.EOM) flag true plus start datetime as last business day of month with start datetime adjust of NONE
        # [NOV_29_2013, NOV_30, Frequency(months=3), None, RollConvention(RollConventionType.EOM), BDA, None, None,
        #  BDA_NONE,
        #  [NOV_30_2013, FEB_28, MAY_31, AUG_31, NOV_30],
        #  [NOV_29_2013, FEB_28, MAY_30, AUG_29, NOV_28], RollConvention(RollConventionType.EOM)],
        # # RollConvention(RollConventionType.EOM) flag false, short initial, implies RollConvention(RollConventionType.EOM) true
        # [datetime(2011, 6, 2), datetime(2011, 8, 31), Frequency(months=1),
        #  StubConvention(StubConventionType.SHORT_INITIAL),
        ...
        #  RollConvention(RollConventionType.EOM)],
        # # RollConvention(RollConventionType.EOM) flag false, explicit stub, implies RollConvention(RollConventionType.EOM) true
        # [datetime(2011, 7, 31), datetime(2011, 10, 10), Frequency(months=1), None, None, BDA, None,
        #  datetime(2011, 9, 30),
        #  None,
        ...
        # [JUL_17, OCT_17, Frequency(months=1), None, RollConvention(RollConventionType.DAY_17), BDA, None, None,
        #  BDA_NONE,
        ...
        # [AUG_18, OCT_17, Frequency(months=1), None, RollConvention(RollConventionType.DAY_17), BDA, None, None,
        #  BDA_NONE,
        ...
        # [JUL_11, OCT_17, Frequency(months=1), None, RollConvention(RollConventionType.DAY_17), BDA, AUG_18, None,
        #  BDA_NONE,
        ...
        # [JUL_17, OCT_17, Frequency(months=1), None, RollConvention(RollConventionType.DAY_17), BDA, None, AUG_18,
        #  BDA_NONE,
        ...
        # [APR_01, OCT_17, Frequency(months=1), None, RollConvention(RollConventionType.DAY_17), BDA, MAY_19, AUG_18,
        #  BDA_NONE,
        ...
        # [JUL_17, AUG_18, Frequency(months=1), None, RollConvention(RollConventionType.DAY_17), BDA, None, None,
        #  BDA_NONE,
        #  [JUL_17, AUG_17],
        ...
        # [JUN_04, SEP_17, Frequency(months=12), StubConvention(StubConventionType.SHORT_INITIAL), None, BDA, SEP_17,
        #  None, None,
        #  [JUN_04, SEP_17],
        #  [JUN_04, SEP_17], RollConvention(RollConventionType.DAY_17)],
        # [JUN_04, SEP_17, Frequency(months=12), StubConvention(StubConventionType.SHORT_INITIAL), None, BDA, None,
        #  JUN_04, None,
        #  [JUN_04, SEP_17],
        #  [JUN_04, SEP_17], RollConvention(RollConventionType.DAY_4)],
        # [datetime(2014, 9, 24), datetime(2016, 11, 24), Frequency(years=2),
        #  StubConvention(StubConventionType.SHORT_INITIAL), None, BDA, None, None, None,
        ...
        # [datetime(2014, 9, 17), datetime(2014, 10, 15), Frequency(months=1), STUB_NONE,
        #  RollConvention(RollConventionType.IMM), BDA, None, None, None,
        #  [datetime(2014, 9, 17), datetime(2014, 10, 15)],
        #  [datetime(2014, 9, 17), datetime(2014, 10, 15)], RollConvention(RollConventionType.IMM)],
        # [datetime(2014, 9, 17), datetime(2014, 10, 15), Frequency(), STUB_NONE, RollConvention(RollConventionType.IMM),
        #  BDA, None, None, None,
        #  [datetime(2014, 9, 17), datetime(2014, 10, 15)],
        #  [datetime(2014, 9, 17), datetime(2014, 10, 15)], RollConvention(RollConventionType.IMM)],
        # # RollConvention(RollConventionType.IMM) with stupid short period still works
        # [datetime(2014, 9, 17), datetime(2014, 10, 15), Frequency(days=2), STUB_NONE,
        #  RollConvention(RollConventionType.IMM), BDA, None, None, None,
        #  [datetime(2014, 9, 17), datetime(2014, 10, 15)],
        #  [datetime(2014, 9, 17), datetime(2014, 10, 15)], RollConvention(RollConventionType.IMM)],
        # [datetime(2014, 9, 17), datetime(2014, 10, 1), Frequency(days=2), STUB_NONE,
        #  RollConvention(RollConventionType.IMM), BDA, None, None, None,
        ...
        # # MF, no stub
        # [datetime(2018, 3, 22), datetime(2020, 3, 18), Frequency(months=6), STUB_NONE,
        #  RollConvention(RollConventionType.IMM), BDA_JPY_MF, None, None, BDA_NONE,
        ...
        # # Preceding, no stub
        # [datetime(2018, 3, 20), datetime(2019, 3, 20), Frequency(months=6), STUB_NONE,
        #  RollConvention(RollConventionType.IMM), BDA_JPY_P, None, None, BDA_NONE,
        ...
        # # MF, None stub
        # [datetime(2018, 3, 22), datetime(2019, 3, 20), Frequency(months=6), None,
        #  RollConvention(RollConventionType.IMM), BDA_JPY_MF, None, None, BDA_NONE,
        #  [datetime(2018, 3, 21), datetime(2018, 9, 19), datetime(2019, 3, 20)],
        ...
        # [datetime(2017, 9, 2), datetime(2018, 9, 19), Frequency(months=6),
        #  StubConvention(StubConventionType.LONG_INITIAL), RollConvention(RollConventionType.IMM), BDA_JPY_MF,
        #  datetime(2018, 3, 22), None,
        #  BDA_NONE,
        ...
        # [datetime(2018, 1, 2), datetime(2018, 9, 19), Frequency(months=6), None, RollConvention(RollConventionType.IMM),
        #  BDA_JPY_MF, datetime(2018, 3, 22), None, BDA_NONE,
        ...
        # [datetime(2017, 3, 15), datetime(2018, 5, 19), Frequency(months=6), None,
        #  RollConvention(RollConventionType.IMM), BDA_JPY_MF, None, datetime(2018, 3, 22), BDA_NONE,
        #  [datetime(2017, 3, 15), datetime(2017, 9, 20), datetime(2018, 3, 21), datetime(2018, 5, 19)],
        #  [datetime(2017, 3, 15), datetime(2017, 9, 20), datetime(2018, 3, 22), datetime(2018, 5, 21)],
        #  RollConvention(RollConventionType.IMM)],

        # # Day30 rolling with February
        # [datetime(2015, 1, 30), datetime(2015, 4, 30), Frequency(months=1), STUB_NONE,
        #  RollConvention(RollConventionType.DAY_30), BDA, None, None, None,
        #  [datetime(2015, 1, 30), datetime(2015, 2, 28), datetime(2015, 3, 30), datetime(2015, 4, 30)],
        #  [datetime(2015, 1, 30), datetime(2015, 2, 27), datetime(2015, 3, 30), datetime(2015, 4, 30)],
        #  RollConvention(RollConventionType.DAY_30)],
        # [datetime(2015, 2, 28), datetime(2015, 4, 30), Frequency(months=1), STUB_NONE,
        #  RollConvention(RollConventionType.DAY_30), BDA, None, None, None,
        #  [datetime(2015, 2, 28), datetime(2015, 3, 30), datetime(2015, 4, 30)],
        #  [datetime(2015, 2, 27), datetime(2015, 3, 30), datetime(2015, 4, 30)],
        #  RollConvention(RollConventionType.DAY_30)],
        # [datetime(2015, 2, 28), datetime(2015, 4, 30), Frequency(months=1),
        #  StubConvention(StubConventionType.SHORT_INITIAL), RollConvention(RollConventionType.DAY_30), BDA, None, None,
        #  None,
        #  [datetime(2015, 2, 28), datetime(2015, 3, 30), datetime(2015, 4, 30)],
        #  [datetime(2015, 2, 27), datetime(2015, 3, 30), datetime(2015, 4, 30)],
        #  RollConvention(RollConventionType.DAY_30)],
        ...
        # [datetime(2019, 1, 16), datetime(2020, 10, 22), Frequency(months=12), None,
        #  RollConvention(RollConventionType.DAY_22), BDA, datetime(2020, 1, 22),
        #  datetime(2020, 1, 22), None,
        #  [datetime(2019, 1, 16), datetime(2020, 1, 22), datetime(2020, 10, 22)],
        #  [datetime(2019, 1, 16), datetime(2020, 1, 22), datetime(2020, 10, 22)],
        #  RollConvention(RollConventionType.DAY_22)],
        # [datetime(2019, 1, 16), datetime(2020, 10, 22), Frequency(months=12), STUB_BOTH,
        #  RollConvention(RollConventionType.DAY_22), BDA, datetime(2020, 1, 22),
        #  datetime(2020, 1, 22),
        #  None,
        #  [datetime(2019, 1, 16), datetime(2020, 1, 22), datetime(2020, 10, 22)],
...
def test_monthly_schedule():
    data = data_gen()
    for d in data:
        (start, end, freq, stub_conv, roll_conv, bday_adj, first_reg, last_reg, start_date_bday_adj, unadjusted,
         adjusted, expected_roll) = d
        ps = PeriodicSchedule(
            unadjusted_start_date=start,
            unadjusted_end_date=end,
            freq=freq,
            bday_adj=bday_adj,
            stub_conv=stub_conv,
            roll_conv=roll_conv,
            start_date_bday_adj=start_date_bday_adj,
            first_regular_start_date=first_reg,
            last_regular_end_date=last_reg
        )
        sched = ps.create_schedule(CAL)
        assert sched.size() == len(unadjusted) - 1
        for i in range(sched.size()):
            period = sched.get_period(i)
            assert period.get_unadjusted_start_date() == unadjusted[i]
            assert period.get_unadjusted_end_date() == unadjusted[i + 1]
            assert period.get_start_date() == adjusted[i]
            assert period.get_end_date() == adjusted[i + 1]
        assert sched.get_frequency() == freq
        assert sched.get_roll_convention() == expected_roll
